...
catalog_directory_lookup = {
        'discovery':    ['TNS','s{:02d}/sector{:0d}_cam{}_transients.txt'],
        'prediscovery': ['TNS','s{:02d}/sector{:0d}_cam{}_transients.txt'],
        'postdiscovery':['TNS','s{:02d}/sector{:0d}_cam{}_transients.txt'],
...
def find_catalog_file(cat_identity,sector,cam):
        ...
        return os.path.join(os.environ.get('PYTHONPATH'), 'catalog2tess_px',
                            dstem[0],
